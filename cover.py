...
- Real-screen coordinates (0..WIDTH, 0..HEIGHT) with center at (WIDTH//2, HEIGHT//2)
...
- Real-time CPU usage display (local laptop resource utilization)
...
def display():
    global cpu_usage
    cpu_usage = psutil.cpu_percent(interval=None)  # read CPU usage
    ...
    draw_text(10, 10, f"CPU Usage: {cpu_usage:.1f}%")
...
def main():
    ...
    glutCreateWindow(b"Coverage Analyzer - MPCA + CPU")
